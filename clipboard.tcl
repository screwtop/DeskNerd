...
# TODO: have the code here use -type UTF8_STRING as well?
proc readclip {} {
	after 50 {
...
# TODO: maybe prompt user to install beep if not available
...
# TODO: detect file format and apply -type?  Want to handle UTF-8 as well as ASCII!
