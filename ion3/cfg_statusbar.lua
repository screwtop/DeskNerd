...
mod_statusbar.create{
    ...
    template = "%systray_files %systray_launcher %systray_instalaunch  | %hostname | Load: %<load  |  %cmeactiveinfo_clientname on %cmeactiveinfo_wsname:%cmeactiveinfo_framename (PID=%cmeactiveinfo_pid)  %|systray_dialog %systray%filler  %systray_notifier %systray_log_viewer  CPU: %systray_monitor_cpu  Disk: %systray_monitor_io  %systray_time ",
